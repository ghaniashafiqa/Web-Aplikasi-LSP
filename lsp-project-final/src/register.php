      ...
      <div class="col-md-7 p-0">
        <form action="register.php" method="post" class="form">
          ...
          <div class="form-input mb-3 icon form-container d-flex">
              ...
              <input type="password" class="form-control" minlength=6 maxlength=8 required name="password" id="password" 
          ...
          <div class="form-input mb-4 icon form-container d-flex">
              <span><i class="fa-solid fa-lock"></i></span>
              <input type="password" class="form-control" minlength=6 maxlength=8 required name="repass" id="repass" 
